...
document.body.innerHTML += `Seu nome tem: ${nome.length} letras <br>`; //Tamanho do nome
document.body.innerHTML += `A segunda letra do seu nome é: ${nome[1]} <br>`; //Segundo caractere do nome
