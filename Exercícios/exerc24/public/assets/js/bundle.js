...
var GeraCpf = /*#__PURE__*/function () {
  ...
  _createClass(GeraCpf, [{
    ...
    value: function geraNovoCpf() {
      ...
      var digito1 = _ValidaCpf__WEBPACK_IMPORTED_MODULE_0__["default"].calculaDigito(cpfLimpo);
      var digito2 = _ValidaCpf__WEBPACK_IMPORTED_MODULE_0__["default"].calculaDigito(cpfLimpo + digito1);
...
var ValidaCpf = /*#__PURE__*/function () {
  ...
  _createClass(ValidaCpf, [{
    key: "checkCpf",
    value: function checkCpf(cpf) {
      var digito1 = ValidaCpf.calculaDigito(this.cpf.slice(0, 9));
      var digito2 = ValidaCpf.calculaDigito(this.cpf.slice(0, 10));
...
.result{
    ...
    margin: 1rem auto;
    font-weight: normal;
}`, "",{"version":3,"sources":["webpack://./src/assets/css/style.css"],"names":[],"mappings":"AAAA;IACI,UAAU;IACV,SAAS;IACT,UAAU;IACV,sBAAsB;AAC1B;;AAEA;IACI,yBAAyB;IACzB,aAAa;IACb,YAAY;IACZ,yCAAyC;IACzC,aAAa;IACb,uBAAuB;AAC3B;;AAEA;IACI,uBAAuB;IACvB,YAAY;IACZ,WAAW;IACX,kBAAkB;IAClB,iBAAiB;IACjB,iBAAiB;AACrB;;AAEA;IACI,kBAAkB;IAClB,iBAAiB;IACjB,mBAAmB;AACvB","sourcesContent":["*{\r\n    padding: 0;\r\n    margin: 0;\r\n    outline: 0;\r\n    box-sizing: border-box;\r\n}\r\n\r\nbody{\r\n    background-color: #0d5452;\r\n    height: 100vh;\r\n    width: 100vw;\r\n    font-family: Arial, Helvetica, sans-serif;\r\n    display: flex;\r\n    justify-content: center;\r\n}\r\n\r\n.container{\r\n    background-color: white;\r\n    height: auto;\r\n    width: 50vw;\r\n    padding: 2rem 1rem;\r\n    border-radius: 2%;\r\n    font-weight: bold;\r\n}\r\n\r\n.result{\r\n    text-align: center;\r\n    margin: 1rem auto;\r\n    font-weight: normal;\r\n}"],"sourceRoot":""}]);
// Exports
...
var createCpf = new _modules_GeraCpf__WEBPACK_IMPORTED_MODULE_0__["default"]();
